...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { dollar_price: @case.dollar_price, euro_price: @case.euro_price, link: @case.link, name: @case.name, performance: @case.performance, size: @case.size }
    end
  ...
  test "should update case" do
    patch :update, id: @case, case: { dollar_price: @case.dollar_price, euro_price: @case.euro_price, link: @case.link, name: @case.name, performance: @case.performance, size: @case.size }
    assert_redirected_to case_path(assigns(:case))
  end
